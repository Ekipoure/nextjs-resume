...
var Personal = defineDocumentType(() => ({
  name: "Personal",
  ...
  fields: {
    ...
    location: {
      type: "string",
      description: "Your general location of residence, not your personal address",
      required: true
    }
  }
}));
var Skill = defineDocumentType(() => ({
  name: "Skill",
...
var ProfessionalTitle = defineNestedType(() => ({
  ...
  fields: {
    ...
    endDate: {
      type: "string",
      description: "The year when you ended the role, or empty if it is your current role",
      required: false
    },
    description: {
      type: "string",
      description: "A description of the work you did under this role, or your accomplishments that led to a promotion",
      required: false
    }
  }
}));
var ProfessionalExperience = defineDocumentType(() => ({
...
var Achievement = defineDocumentType(() => ({
  ...
  fields: {
    ...
    organization: {
      type: "string",
      description: "The name of the school, organization, or program you earned your achievement from",
      required: true
    },
    completionYear: {
      type: "number",
...
var AdditionalInfo = defineDocumentType(() => ({
  name: "AdditionalInfo",
...
var PrivateField = defineDocumentType(() => ({
  name: "PrivateField",
...
//# sourceMappingURL=compiled-contentlayer-config-DSYOOCNP.mjs.map
